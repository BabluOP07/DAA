public class KMPImpl {
    static int kmpSearch(String string, String pattern) {
    ...
    public static void main(String args[]) {
        String pattern="wasd", string="qwertywasduiop";

        int index = kmpSearch(string, pattern);
        if (index == -1) System.out.println("The pattern is not found");
        else System.out.println("The pattern "+ pattern +" is found in the given string " + string + " at index: "+index);
